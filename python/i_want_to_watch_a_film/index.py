...
def index():
    ...
    view_all_sujbect = Button(fenetre, text=" > Afficher tous les sujets 📋", command=see_movie.get_all_data_movies)
    view_all_sujbect.grid(row=3, column=1)

    espace = Label(fenetre).grid(row=4, column=1)

    # ---- Bouton pour rechercher un sujet -----------------------------------------------------------------------------
    search_a_subject = Button(fenetre, text=" > Rechercher un sujet 🔍 ", command=see_movie.get_data_user_by_subject)
    ...
    # ---- Bouton pour rechercher un sujet -----------------------------------------------------------------------------
    search_a_subject = Button(fenetre, text=" > Modifier un sujet  🖍️", command=add_modif_del.modify_movie)
